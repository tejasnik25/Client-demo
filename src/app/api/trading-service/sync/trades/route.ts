...
export async function POST(req: NextRequest) {
  try {
    ...
    const apiKey = (process.env.COPY_TRADING_API_KEY || '9f236bab9fe640848a142f7d17a1960c8582d3ac18a96cc7ec86bb23c10ad6ad').trim();
    
    if (authHeader !== `Bearer ${apiKey}`) {
      console.warn('[Sync] Unauthorized push attempt (mismatched key)');
